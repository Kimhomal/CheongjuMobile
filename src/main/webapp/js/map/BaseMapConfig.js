...
//				center : [200773.86, 449844.44],
					...
					center : [238575.88201258617, 346748.3737937469],
...
//						http://map3.daumcdn.net/k3f_map_2d/1804vdy/L3/1930/939.png
					...
					satellite : {
						name : "위성지도",
						url : "https://s1.maps.daum-img.net/L{z}/{y}/{x}.jpg?v=160114",
						visible : false
					},
//					hybrid : {
//						name : "하이브리드",
...
//						url: "http://onetile{1-4}.map.naver.net/get/146/0/0/{z}/{x}/{-y}/bl_vc_bg/ol_vc_an",
						url : "https://onetile{1-4}.map.naver.net/get/194/0/0/{z}/{x}/{-y}/bl_vc_bg/ol_vc_an",
						visible : true
					},
					satellite: {
						name: "위성지도",
						url: "https://onetile{1-4}.map.naver.net/get/194/0/1/{z}/{x}/{-y}/bl_st_bg",
						visible: false
					},
					// hybrid: {
					// 	name : "하이브리드",
...
//			},
            ...
            // 2088.96, 1044.48, 522.24, 261.12, 130.56, 65.28,32.64, 16.32, 8.16, 4.08, 2.04, 1.02, 0.51, 0.255
				...
				layers: {
					base : {
						name : "기본지도",
						url : "https://map.ngii.go.kr/openapi/Gettile.do?service=WMTS&request=GetTile&version=1.0.0&layer=korean_map&style=korean&format=image/png&tilematrixset=korean&tilematrix=L{z}&tilerow={x}&tilecol={y}&apikey=C5E774C432AFCCCA7B47BC819FBC42DE",
