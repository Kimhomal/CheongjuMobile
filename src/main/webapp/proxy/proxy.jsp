...
// 				con.setRequestProperty("O2MAP_PID", request.getSession().getId());		// session through proxy
		...
		//System.out.println("end session id :   " + request.getSession().getId());
