...
<form  action="${context}/statistics/selectDetailFcltsExcelDown.do" id="frm" name="frm" method="post">
    ...
    <input type="hidden" id="facilityName" name="facilityName" value="노면방향표시" />
...
<script>
    ...
    $(function() {
        ...
        mCtlMet =  new MultiSelectBoard("#mCtlMet", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=DRN_CDE&refCd=A055_P'/>",
            type : "get",
            caption : "*방향코드",
            allSelect : false,
            colNames : [
        ...
        $(".btn_excel").click(function() {
            ...
            $("#arrHeader").val("번호, 관리번호, 경찰서명, 구명, 동명, 지번, 교차로, 설치일자, 방향코드, X좌표(EPSG:5181), Y좌표(EPSG:5181)");
            $("#frm").submit();
        });
