...
<form  action="${context}/statistics/selectDetailFcltsExcelDown.do" id="frm" name="frm" method="post">
    ...
    <input type="hidden" id="facilityName" name="facilityName" value="횡단보도" />
    ...
    <input type="hidden" id="slYnCde" name="slYnCde" value="" />
...
<script>
    ...
    $(function() {
        ...
        mSlYn =  new MultiSelectBoard("#mSlYn", {
        ...
        $(".btn_excel").click(function() {
            ...
            $("#slYnCde").val(mCtlMet.getSelectVal());
            $("#arrHeader").val("번호, 관리번호, 경찰서명, 구명, 동명, 지번, 교차로, 형식, 설치일자, 신호등존재유무, 폭");
            $("#frm").submit();
        });
