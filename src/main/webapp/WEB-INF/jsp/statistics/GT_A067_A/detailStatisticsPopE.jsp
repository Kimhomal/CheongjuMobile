...
<form  action="${context}/statistics/selectDetailFcltsExcelDown.do" id="frm" name="frm" method="post">
	...
	<input type="hidden" id="facilityName" name="facilityName" value="과속방지턱" />
	...
	<div class="contBox_tp3" style="width: 761px;">
		<div class="area_wrap">
			...
			<div class="area_r w50p pd_r10">
				...
				<div id="mFrmCfn" class="board"></div>
			</div>
			<div class="area_l w50p pd_r10">
...
<script>
    ...
    $(function() {
        ...
        mFrmCfn =  new MultiSelectBoard("#mFrmCfn", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=FRM_CFN&refCd=A067_A'/>",
            type : "get",
            caption : "*형상분류",
            allSelect : false,
            colNames : [
        ...
        mKnd =  new MultiSelectBoard("#mKnd", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=KND&refCd=A067_A'/>",
            type : "get",
            caption : "*유형",
            allSelect : false,
            colNames : [
        ...
        $(".btn_excel").click(function() {
            ...
            $("#arrHeader").val("번호, 관리번호, 경찰서명, 구명, 동명, 지번, 교차로, 유형, 형상, 폭, 길이, 설치일자");
            $("#frm").submit();
        });
