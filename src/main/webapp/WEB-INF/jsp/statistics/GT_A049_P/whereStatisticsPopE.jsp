...
<script>
    ...
    $(function() {
        ...
        mDong =  new MultiSelectBoard("#mDong", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=emdCdeByGu'/>",
            type : "get",
            caption : "*읍면동",
            allSelect : false,
            colNames : [
		...
		$("#mGu").on("click", function() {
			mDong.reloadList({
				sigCd : mGu.getSelectVal()
			});
		});
            ...
            html2canvas($("canvas")[0]).then(function(canvas) {
                $.ajax({
                    ...
                    success : function() {
                        ...
                        $("#arrHeader").val("구분, 합계, 전광판, 단속용, 신호기");
                        $("#frm").submit();
                    }
                });
            });
