...
<form  action="${context}/statistics/selectDetailFcltsExcelDown.do" id="frm" name="frm" method="post">
    ...
    <input type="hidden" id="facilityName" name="facilityName" value="부착대" />
    ...
    <input type="hidden" id="statCde" name="statCde" value="" />
...
<script>
    ...
    $(function() {
        ...
        mStat =  new MultiSelectBoard("#mStat", {
        ...
        $(".btn_excel").click(function() {
            ...
            $("#statCde").val(mKnd.getSelectVal());
            $("#arrHeader").val("번호, 관리번호, 경찰서명, 구명, 동명, 지번, 교차로, 길이, 설치일자, 용도, 상태");
            $("#frm").submit();
        });
