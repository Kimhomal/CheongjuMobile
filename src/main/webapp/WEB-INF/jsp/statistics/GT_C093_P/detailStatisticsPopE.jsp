...
<form  action="${context}/statistics/selectDetailFcltsExcelDown.do" id="frm" name="frm" method="post">
    ...
    <input type="hidden" id="facilityName" name="facilityName" value="시선유도표지" />
...
<script>
    ...
    $(function() {
        ...
        mEsbFrm =  new MultiSelectBoard("#mEsbFrm", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=ESB_FRM&refCd=C093_P'/>",
            type : "get",
            caption : "*설치형태",
            allSelect : false,
            colNames : [
        ...
        $(".btn_excel").click(function() {
            ...
            $("#statGbn").val(mEsbFrm.getSelectVal());
            $("#arrHeader").val("번호, 관리번호, 경찰서명, 구명, 동명, 지번, 교차로, 설치형태, 설치일자, X좌표(EPSG:5181), Y좌표(EPSG:5181)");
            $("#frm").submit();
        });
