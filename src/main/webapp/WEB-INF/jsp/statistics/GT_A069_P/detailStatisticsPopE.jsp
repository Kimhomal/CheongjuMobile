...
<form  action="${context}/statistics/selectDetailFcltsExcelDown.do" id="frm" name="frm" method="post">
    ...
    <input type="hidden" id="facilityName" name="facilityName" value="CCTV" />
	...
	<input type="hidden" id="cnnTypeCde" name="cnnTypeCde" value="" />
...
<div class="contBox_tp3" style="width: 761px;">
	<div class="area_wrap">
		...
		<div class="area_l w50p pd_r10">
			<div id="mCnnType" class="board"></div>
		</div>
	</div>
...
<script>
    ...
    $(function() {
        ...
        mCnnType =  new MultiSelectBoard("#mCnnType", {
        ...
        $(".btn_excel").click(function() {
            ...
            $("#cnnTypeCde").val(mCnnType.getSelectVal());
            $("#arrHeader").val("번호, 관리번호, 경찰서명, 구명, 동명, 지번, 교차로, 종류, 제조모델, 설치높이, 제조회사, 통신방식, 통신장비(현장), 통신장비(센터), 설치일자, X좌표(EPSG:5181), Y좌표(EPSG:5181)");
            $("#frm").submit();
        });
        ...
        $("#search").click(function() {
            searchResultList.reloadList({
                ...
                cnnTypeCde : mCnnType.getSelectVal(),
                stYmd : $("#stYmd").val(),
                enYmd : $("#enYmd").val()
            });
        });
        ...
        searchResultList = new SearchResultList(".detailBoard", {
            ...
            colNames		: [
                ...
                {name : "종류", width : "120px"},
                {name : "제조모델", width : "120px"},
                {name : "설치높이", width : "120px"},
                {name : "제조회사", width : "120px"},
                {name : "통신방식", width : "120px"},
                {name : "통신장비(현장)", width : "120px"},
                {name : "통신장비(센터)", width : "120px"},
