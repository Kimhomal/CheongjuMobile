...
<form  action="${context}/statistics/selectDetailFcltsExcelDown.do" id="frm" name="frm" method="post">
	...
	<input type="hidden" id="facilityName" name="facilityName" value="도로반사경" />
	...
	<input type="hidden" id="mirrKndCde" name="mirrKndCde" value="" />
	<input type="hidden" id="jijuTypeCde" name="jijuTypeCde" value="" />
	...
	<div class="contBox_tp3" style="width: 761px;">
		<div class="area_wrap">
			...
			<div class="area_r w50p pd_r10">
				...
				<div id="mMirrFrm" class="board"></div>
			</div>
			<div class="area_l w50p pd_r10">
				<div id="mMirrKnd" class="board"></div>
			</div>
			<div class="area_r w50p pd_r10">
				<div id="mJijuType" class="board"></div>
			</div>
		</div>
...
<script>
    ...
    $(function() {
        ...
        mMirrFrm =  new MultiSelectBoard("#mMirrFrm", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=MIRR_FRM&refCd=C051_P'/>",
            type : "get",
            caption : "*형태",
            allSelect : false,
            colNames : [
        ...
        mMirrKnd =  new MultiSelectBoard("#mMirrKnd", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=MIRR_KND&refCd=C051_P'/>",
            type : "get",
            caption : "*종류",
            allSelect : false,
            colNames : [
        ...
        mJijuType =  new MultiSelectBoard("#mJijuType", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=JIJU_TYPE&refCd=C051_P'/>",
            type : "get",
            caption : "*지주타입",
            allSelect : false,
            colNames : [
        ...
        $(".btn_excel").click(function() {
            ...
            $("#statGbn").val(mMirrFrm.getSelectVal());
            $("#mirrKndCde").val(mMirrKnd.getSelectVal());
            $("#jijuTypeCde").val(mJijuType.getSelectVal());
            $("#arrHeader").val("번호, 관리번호, 경찰서명, 구명, 동명, 지번, 교차로, 종류, 설치일자, X좌표(EPSG:5181), Y좌표(EPSG:5181)");
            $("#frm").submit();
        });
        ...
        $("#search").click(function() {
            searchResultList.reloadList({
                ...
                statGbn:mMirrFrm.getSelectVal(),
                mirrKndCde : mMirrKnd.getSelectVal(),
                jijuTypeCde : mJijuType.getSelectVal(),
                stYmd : $("#stYmd").val(),
                enYmd : $("#enYmd").val()
            });
        });
