...
<form  action="${context}/statistics/selectDetailFcltsExcelDown.do" id="frm" name="frm" method="post">
    ...
    <input type="hidden" id="facilityName" name="facilityName" value="주차금지" />
...
<script>
    ...
    $(function() {
        ...
        mKnd =  new MultiSelectBoard("#mKnd", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=KND&refCd=A082_L'/>",
            type : "get",
            caption : "*타입",
            allSelect : false,
            colNames : [
        ...
        $(".btn_excel").click(function() {
            ...
            $("#arrHeader").val("번호, 관리번호, 경찰서명, 구명, 동명, 지번, 교차로, 연장(km), 설치일자, 타입");
            $("#frm").submit();
        });
