...
<form  action="${context}/statistics/selectDetailFcltsExcelDown.do" id="frm" name="frm" method="post">
    ...
    <input type="hidden" id="facilityName" name="facilityName" value="전광판" />
    ...
    <div class="contBox_tp3" style="width: 761px;">
        <div class="area_wrap">
            ...
            <div class="area_r w50p pd_r10">
                ...
                <div id="mLhbKnd" class="board"></div>
            </div>
        </div>
...
<script>
    ...
    $(function() {
        ...
        mLhbKnd =  new MultiSelectBoard("#mLhbKnd", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=LHB_KND&refCd=C097_P'/>",
            type : "get",
            caption : "*종류",
            allSelect : false,
            colNames : [
        ...
        $(".btn_excel").click(function() {
            ...
            $("#statGbn").val(mLhbKnd.getSelectVal());
            $("#arrHeader").val("번호, 관리번호, 경찰서명, 구명, 동명, 지번, 교차로, 종류, 규격, 설치일자, X좌표(EPSG:5181), Y좌표(EPSG:5181)");
            $("#frm").submit();
        });
