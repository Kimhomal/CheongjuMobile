...
<form  action="${context}/statistics/selectDetailFcltsExcelDown.do" id="frm" name="frm" method="post">
    ...
    <input type="hidden" id="facilityName" name="facilityName" value="가로등" />
...
<script>
    ...
    $(function() {
        ...
        mGbn =  new MultiSelectBoard("#mGbn", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=GBN&refCd=C100_P'/>",
            type : "get",
            caption : "*구분",
            allSelect : false,
            colNames : [
        ...
        $(".btn_excel").click(function() {
            ...
            $("#statGbn").val(mGbn.getSelectVal());
            $("#arrHeader").val("번호, 관리번호, 경찰서명, 구명, 동명, 지번, 교차로, 구분, X좌표(EPSG:5181), Y좌표(EPSG:5181)");
            $("#frm").submit();
        });
