...
<form  action="${context}/statistics/selectDetailFcltsExcelDown.do" id="frm" name="frm" method="post">
    ...
    <input type="hidden" id="facilityName" name="facilityName" value="안전표지" />
    ...
    <input type="hidden" id="stdCde" name="stdCde" value="" />
	<input type="hidden" id="morCde" name="morCde" value="" />
	<input type="hidden" id="sprtKndCde" name="sprtKndCde" value="" />
	<input type="hidden" id="sprtKndCde" name="sptMrkCde" value="" />
...
<div class="contBox_tp3" style="width: 761px;">
	<div class="area_wrap">
		...
		<div class="area_l w50p pd_r10">
			<div id="mStd" class="board"></div>
			<div id="mMor" class="board"></div>
		</div>
		<div class="area_r w50p pd_r10">
			<div id="mSprtKnd" class="board"></div>
			<div id="mSptMrk" class="board"></div>
		</div>
	</div>
...
<script>
    ...
    $(function() {
        ...
        mStd =  new MultiSelectBoard("#mStd", {
        ...
        mMor =  new MultiSelectBoard("#mMor", {
        ...
        mSprtKnd =  new MultiSelectBoard("#mSprtKnd", {
        ...
        mSptMrk =  new MultiSelectBoard("#mSptMrk", {
        ...
        $(".btn_excel").click(function() {
            ...
            $("#stdCde").val(mStd.getSelectVal());
            $("#morCde").val(mMor.getSelectVal());
            $("#sprtKndCde").val(mSprtKnd.getSelectVal());
            $("#sptMrkCde").val(mSptMrk.getSelectVal());
            $("#arrHeader").val("번호, 관리번호, 경찰서명, 구명, 동명, 지번, 교차로, 구분, 설치일자, 규격, 반사재, 지주종류, 보조표지, X좌표(EPSG:5181), Y좌표(EPSG:5181)");
            $("#frm").submit();
        });
        ...
        $("#search").click(function() {
            searchResultList.reloadList({
                ...
                stdCde : mStd.getSelectVal(),
                morCde : mMor.getSelectVal(),
                sprtKndCde : mSprtKnd.getSelectVal(),
                sptMrkCde : mSptMrk.getSelectVal(),
                stYmd : $("#stYmd").val(),
                enYmd : $("#enYmd").val()
            });
        });
        ...
        searchResultList = new SearchResultList(".detailBoard", {
            ...
            colNames		: [
                ...
                {name : "규격", width : "90px"},
                {name : "반사재", width : "120px"},
                {name : "지주종류", width : "90px"},
                {name : "보조표지", width : "90px"},
