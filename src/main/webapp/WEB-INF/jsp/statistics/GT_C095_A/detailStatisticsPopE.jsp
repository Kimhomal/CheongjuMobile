...
<form  action="${context}/statistics/selectDetailFcltsExcelDown.do" id="frm" name="frm" method="post">
    ...
    <input type="hidden" id="facilityName" name="facilityName" value="입체횡단시설" />
    ...
    <input type="hidden" id="epsCde" name="epsCde" value="" />
...
<script>
    ...
    $(function() {
        ...
        mKnd =  new MultiSelectBoard("#mKnd", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=KND&refCd=C095_A'/>",
            type : "get",
            caption : "*종류",
            allSelect : false,
            colNames : [
        ...
        mEps =  new MultiSelectBoard("#mEps", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=EPS&refCd=C095_A'/>",
            type : "get",
            caption : "*용도",
            allSelect : false,
            colNames : [
        ...
        $(".btn_excel").click(function() {
            ...
            $("#epsCde").val(mEps.getSelectVal());
            $("#arrHeader").val("번호, 관리번호, 경찰서명, 구명, 동명, 지번, 교차로, 종류, 용도, 설치일자");
            $("#frm").submit();
        });
