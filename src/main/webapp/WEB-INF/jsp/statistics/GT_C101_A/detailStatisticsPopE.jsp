...
<form  action="${context}/statistics/selectDetailFcltsExcelDown.do" id="frm" name="frm" method="post">
    ...
    <input type="hidden" id="facilityName" name="facilityName" value="어린이보호구역" />
...
<script>
    ...
    $(function() {
        ...
        $(".btn_excel").click(function() {
            ...
            $("#arrHeader").val("번호, 관리번호, 경찰서명, 구명, 동명, 지번, 교차로, 시설종류, 설치일자, 등록일, 어린이보호구역명, 전화번호, 길이, 도로폭, 속도제한, 사망자수, 부상자수, 메모");
            $("#frm").submit();
        });
        ...
        searchResultList = new SearchResultList(".detailBoard", {
            ...
            colNames		: [
                ...
                {name : "시설종류", width : "100px"},
                {name : "설치일자", width : "100px"},
                {name : "등록일자", width : "100px"},
                {name : "어린이보호구역명", width : "100px"},
                {name : "전화번호", width : "100px"},
                {name : "길이", width : "100px"},
                {name : "도로폭", width : "100px"},
                {name : "속도제한", width : "100px"},
                {name : "사망자수", width : "100px"},
                {name : "부상자수", width : "100px"},
                {name : "메모", width : "100px"}
            ],
            colModel		: [
                {name : "num"},
