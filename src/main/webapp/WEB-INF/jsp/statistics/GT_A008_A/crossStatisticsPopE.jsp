...
<form  action="${context}/statistics/selectStatisticsExcelDown.do" id="frm" name="frm" method="post">
	...
	<input type="hidden" id="facilityName" name="facilityName" value="교차로" />
	...
	<input type="hidden" id="typeCde" name="typeCde" value="" />
	...
	<div class="contBox_tp3" style="width: 761px;">
		<div class="area_wrap">
			...
			<div class="area_r w50p pd_r10">
				...
				<div id="mCssKnd" class="board"></div>
			</div>
			<div class="area_l w50p pd_r10">
				<div id="mTypeCde" class="board"></div>
			</div>
		</div>
...
<script>
    ...
    $(function() {
        ...
        mCssKnd =  new MultiSelectBoard("#mCssKnd", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=CSS_KND&refCd=A008_A'/>",
            type : "get",
            caption : "*형태",
            allSelect : false,
            colNames : [
        ...
        mTypeCde =  new MultiSelectBoard("#mTypeCde", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=TYPE_CDE&refCd=A008_A'/>",
            type : "get",
            caption : "*유형",
            allSelect : false,
            colNames : [
        ...
        $(".btn_excel").click(function() {
            ...
            $("#statGbn").val(mCssKnd.getSelectVal());
            $("#typeCde").val(mTypeCde.getSelectVal());
            $("#arrHeader").val("구분, 형태, 유형, 제어기, 신호등, 부착대, 지주, 음향신호기, 보행자버튼, 검지기, 보행용조명, 횡단보도");
            $("#frm").submit();
        });
        ...
        $("#stat").on("click",function () {
            statisticsTable.reloadList({
                ...
                statGbn : mCssKnd.getSelectVal(),
                typeCde : mTypeCde.getSelectVal(),
                stYmd : $("#stYmd").val(),
                enYmd : $("#enYmd").val(),
                cssNam :  $("#cssNam").val()
            });
