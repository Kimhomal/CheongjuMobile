...
<form  action="${context}/statistics/selectDetailFcltsExcelDown.do" id="frm" name="frm" method="post">
    ...
    <input type="hidden" id="facilityName" name="facilityName" value="지주" />
	...
	<input type="hidden" id="sprtDanCde" name="sprtDanCde" value="" />
...
<div class="contBox_tp3" style="width: 761px;">
	<div class="area_wrap">
		...
		<div class="area_l w50p pd_r10">
			<div id="mSprtDan" class="board"></div>
		</div>
		<div class="area_r w50p pd_r10">
...
<script>
    ...
    $(function() {
        ...
        mSprtDan =  new MultiSelectBoard("#mSprtDan", {
        ...
        $(".btn_excel").click(function() {
            ...
            $("#sprtDanCde").val(mSprtDan.getSelectVal());
            $("#mopCde").val(mMop.getSelectVal());
            $("#arrHeader").val("번호, 관리번호, 경찰서명, 구명, 동명, 지번, 교차로, 구분, 설치일자, 지주지름, 재질, 지주높이, 지주단, X좌표(EPSG:5181), Y좌표(EPSG:5181)");
            $("#frm").submit();
        });
        ...
        $("#search").click(function() {
            searchResultList.reloadList({
                ...
                sprtDanCde : mSprtDan.getSelectVal(),
        ...
        searchResultList = new SearchResultList(".detailBoard", {
            ...
            colNames		: [
                ...
                {name : "지주지름", width : "100px"},
                {name : "재질", width : "120px"},
                {name : "지주높이", width : "100px"},
                {name : "지주단", width : "100px"},
