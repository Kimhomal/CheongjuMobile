...
<form  action="${context}/statistics/selectDetailFcltsExcelDown.do" id="frm" name="frm" method="post">
	...
	<input type="hidden" id="facilityName" name="facilityName" value="미끄럼방지시설" />
	...
	<div class="contBox_tp3" style="width: 761px;">
		<div class="area_wrap">
			...
			<div class="area_r w50p pd_r10">
				...
				<div id="mEcnKnd" class="board"></div>
			</div>
		</div>
...
<script>
    ...
    $(function() {
        ...
        mEcnKnd =  new MultiSelectBoard("#mEcnKnd", {
        ...
        $(".btn_excel").click(function() {
            ...
            $("#statGbn").val(mEcnKnd.getSelectVal());
            $("#arrHeader").val("번호, 관리번호, 경찰서명, 구명, 동명, 지번, 교차로, 시공종류, 넓이, 설치일자");
            $("#frm").submit();
        });
