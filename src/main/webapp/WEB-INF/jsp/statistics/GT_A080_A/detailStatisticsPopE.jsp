...
<form  action="${context}/statistics/selectDetailFcltsExcelDown.do" id="frm" name="frm" method="post">
    ...
    <input type="hidden" id="facilityName" name="facilityName" value="주차구획" />
...
<script>
    ...
    $(function() {
        ...
        mCtlMet =  new MultiSelectBoard("#mCtlMet", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=KND&refCd=A080_L'/>",
            type : "get",
            caption : "*종류",
            allSelect : false,
            colNames : [
        ...
        mClr =  new MultiSelectBoard("#mClr", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=CLR&refCd=A080_L'/>",
            type : "get",
            caption : "*색상",
            allSelect : false,
            colNames : [
        ...
        $(".btn_excel").click(function() {
            ...
            $("#arrHeader").val("번호, 관리번호, 경찰서명, 구명, 동명, 지번, 교차로, 종류, 설치일자, 색상");
            $("#frm").submit();
        });
