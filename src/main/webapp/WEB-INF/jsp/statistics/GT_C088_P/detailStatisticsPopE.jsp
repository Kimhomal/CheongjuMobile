...
<form  action="${context}/statistics/selectDetailFcltsExcelDown.do" id="frm" name="frm" method="post">
	...
	<input type="hidden" id="facilityName" name="facilityName" value="갈매기표지" />
	...
	<input type="hidden" id="esbFrmCde" name="esbFrmCde" value="" />
	...
	<div class="contBox_tp3" style="width: 761px;">
		<div class="area_wrap">
			...
			<div class="area_r w50p pd_r10">
				<div id="mEsbFrm" class="board"></div>
			</div>
		</div>
...
<script>
    ...
    $(function() {
        ...
        mKnd =  new MultiSelectBoard("#mKnd", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=KND&refCd=C088_P'/>",
            type : "get",
            caption : "*종류",
            allSelect : false,
            colNames : [
        ...
        mStd =  new MultiSelectBoard("#mStd", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=STD&refCd=C088_P'/>",
            type : "get",
            caption : "*규격",
            allSelect : false,
            colNames : [
        ...
        mEsbFrm =  new MultiSelectBoard("#mEsbFrm", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=ESB_FRM&refCd=C088_P'/>",
            type : "get",
            caption : "*설치형태",
            allSelect : false,
            colNames : [
        ...
        $(".btn_excel").click(function() {
            ...
            $("#esbFrmCde").val(mEsbFrm.getSelectVal());
            $("#arrHeader").val("번호, 관리번호, 경찰서명, 구명, 동명, 지번, 교차로, 종류, 규격, 설치형태, 설치일자, X좌표(EPSG:5181), Y좌표(EPSG:5181)");
            $("#frm").submit();
        });
        ...
        $("#search").click(function() {
            searchResultList.reloadList({
                ...
                esbFrmCde : mEsbFrm.getSelectVal(),
                stYmd : $("#stYmd").val(),
                enYmd : $("#enYmd").val()
            });
        });
