...
<form  action="${context}/statistics/selectDetailFcltsExcelDown.do" id="frm" name="frm" method="post">
    ...
    <input type="hidden" id="facilityName" name="facilityName" value="공영주차장" />
    ...
    <input type="hidden" id="gubunCde" name="gubunCde" value="" />
	<input type="hidden" id="paidFreeCde" name="paidFreeCde" value="" />
...
<div class="contBox_tp3" style="width: 761px;">
	<div class="area_wrap">
		...
		<div class="area_l w50p pd_r10">
			<div id="mGubun" class="board"></div>
		</div>
		<div class="area_r w50p pd_r10">
				<div id="mPaidFree" class="board"></div>
			</div>
	</div>
...
<script>
    ...
    $(function() {
        ...
        mGubun =  new MultiSelectBoard("#mGubun", {
        ...
        mPaidFree =  new MultiSelectBoard("#mPaidFree", {
        ...
        $(".btn_excel").click(function() {
            ...
            $("#gubunCde").val(mGubun.getSelectVal());
            $("#paidFreeCde").val(mPaidFree.getSelectVal());
            $("#arrHeader").val("번호, 관리번호, 경찰서명, 구명, 동명, 지번, 교차로, 설치일자, 급지, 구분, 유무료");
            $("#frm").submit();
        });
        ...
        $("#search").click(function() {
            searchResultList.reloadList({
                ...
                gubunCde : mGubun.getSelectVal(),
                paidFreeCde : mPaidFree.getSelectVal(),
                stYmd : $("#stYmd").val(),
                enYmd : $("#enYmd").val()
            });
        });
        ...
        searchResultList = new SearchResultList(".detailBoard", {
            ...
            colNames		: [
                ...
                {name : "주차장명", width : "100px"},
                {name : "주차면수", width : "100px"},
                {name : "장애인면수", width : "100px"},
                {name : "구분", width : "100px"},
                {name : "유무료", width : "100px"}
            ],
            colModel		: [
                {name : "num"},
                {name : "mgrnu"},
