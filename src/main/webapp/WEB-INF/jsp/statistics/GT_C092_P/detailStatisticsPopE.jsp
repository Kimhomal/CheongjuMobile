...
<form  action="${context}/statistics/selectDetailFcltsExcelDown.do" id="frm" name="frm" method="post">
	...
	<input type="hidden" id="facilityName" name="facilityName" value="시선유도봉" />
	...
	<div class="contBox_tp3" style="width: 761px;">
		<div class="area_wrap">
			...
			<div class="area_r w50p pd_r10">
				...
				<div id="mKndCde" class="board"></div>
			</div>
		</div>
...
<script>
    ...
    $(function() {
        ...
        mKndCde =  new MultiSelectBoard("#mKndCde", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=KND_CDE&refCd=C092_P'/>",
            type : "get",
            caption : "*종류",
            allSelect : false,
            colNames : [
        ...
        $(".btn_excel").click(function() {
            ...
            $("#statGbn").val(mKndCde.getSelectVal());
