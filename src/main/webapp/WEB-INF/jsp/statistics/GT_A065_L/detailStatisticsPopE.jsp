...
<form  action="${context}/statistics/selectDetailFcltsExcelDown.do" id="frm" name="frm" method="post">
    ...
    <input type="hidden" id="facilityName" name="facilityName" value="표지병" />
...
<script>
    ...
    $(function() {
        ...
        mCfn =  new MultiSelectBoard("#mCfn", {
        ...
        $(".btn_excel").click(function() {
            ...
            $("#statGbn").val(mCfn.getSelectVal());
            $("#clrCde").val(mClr.getSelectVal());
            $("#arrHeader").val("번호, 관리번호, 경찰서명, 구명, 동명, 지번, 교차로, 분류, 색상, 설치일자");
            $("#frm").submit();
        });
