...
<form  action="${context}/statistics/selectDetailFcltsExcelDown.do" id="frm" name="frm" method="post">
    ...
    <input type="hidden" id="facilityName" name="facilityName" value="장애물표적표지" />
...
<script>
    ...
    $(function() {
        ...
        mStd =  new MultiSelectBoard("#mStd", {
            url : "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=STD&refCd=C096_P'/>",
            type : "get",
            caption : "*규격",
            allSelect : false,
            colNames : [
        ...
        $(".btn_excel").click(function() {
            ...
            $("#statGbn").val(mStd.getSelectVal());
            $("#arrHeader").val("번호, 관리번호, 경찰서명, 구명, 동명, 지번, 교차로, 규격, 설치일자, X좌표(EPSG:5181), Y좌표(EPSG:5181)");
            $("#frm").submit();
        });
