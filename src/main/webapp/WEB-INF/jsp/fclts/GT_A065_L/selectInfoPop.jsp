...
$(function(){
	...
	var cfn = new AjaxComboBox("#cfn", {
		url				: "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=CFN&refCd=A065_L'/>",
		baseItem	: {name: "--- 선택 ---", value: ""}
	}).load({select: "${result.cfn}"});

	var clr = new AjaxComboBox("#clr", {
		url				: "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=CLR&refCd=A065_L'/>",
		baseItem	: {name: "--- 선택 ---", value: ""}
