...
<div class="tabCont active">
		...
		<ul class="list_tp8 col_tp1">
			...
			<li>
				<div class="tit">폭원</div>
				<div class="cont">
					<c:out value='${result.clrWid}'/>
				</div>
			</li>
			<li>
				<div class="tit">길이</div>
				<div class="cont">
					<c:out value='${result.clrLen}'/>
				</div>
			</li>
			<li>
...
<div class="tabCont">
		...
		<ul class="list_tp8 col_tp1">
			...
			<li>
				<div class="tit">폭원</div>
				<div class="cont">
					<input type="text" id="clrWid" name="clrWid" value="<c:out value='${result.clrWid}'/>" maxlength="50"/>
				</div>
			</li>
			<li>
				<div class="tit">길이</div>
				<div class="cont">
					<input type="text" id="clrLen" name="clrLen" value="<c:out value='${result.clrLen}'/>" maxlength="50"/>
				</div>
			</li>
			<li>
				<div class="tit">주소</div>
