...
<div class="tabCont active">
		...
		<li>
			<div class="tit">노선명</div>
			<div class="cont">
				<c:out value='${result.roadNam}'/>
			</div>
		</li>
		<li>
			<div class="tit">노선시작</div>
			<div class="cont">
				<c:out value='${result.roadSt}'/>
			</div>
		</li>
		<li>
			<div class="tit">노선끝</div>
			<div class="cont">
				<c:out value='${result.roadEd}'/>
			</div>
		</li>
		<li>
...
<div class="tabCont">
		...
		<li>
			<div class="tit">노선명</div>
			<div class="cont">
				<input type="text" id="roadNam" name="roadNam" value="<c:out value='${result.roadNam}'/>" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">노선시작</div>
			<div class="cont">
				<input type="text" id="roadSt" name="roadSt" value="<c:out value='${result.roadSt}'/>" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">노선끝</div>
			<div class="cont">
				<input type="text" id="roadEd" name="roadEd" value="<c:out value='${result.roadEd}'/>" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">주소</div>
