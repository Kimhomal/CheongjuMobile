...
<!-- 노선 등록 : start-->
	...
	<input type="hidden" id="gbn" name="gbn" value="<c:out value='${params.gbn}'/>" />
		...
		<li>
			...
			<div class="cont">
				<input type="text" id="roadNam" name="roadNam" value="" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">노선시작</div>
			<div class="cont">
				<input type="text" id="roadSt" name="roadSt" value="" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">노선끝</div>
			<div class="cont">
				<input type="text" id="roadEd" name="roadEd" value="" maxlength="50"/>
			</div>
		</li>
