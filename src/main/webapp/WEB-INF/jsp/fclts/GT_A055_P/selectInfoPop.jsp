...
<div class="tabCont active">
		...
		<li>
			<div class="tit">방향코드</div>
			<div class="cont">
				<c:out value='${result.drnCdeNam}'/>
			</div>
		</li>
		<li>
...
<div class="tabCont">
		...
		<li>
			<div class="tit"><span class="necessary">*</span>방향코드</div>
			<div class="cont">
				<select id="drnCde" name="drnCde">
				</select>
			</div>
		</li>
		<li>
