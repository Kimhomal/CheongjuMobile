...
<!-- 어린이보호구역 등록 : start-->
	...
	<input type="hidden" id="gbn" name="gbn" value="<c:out value='${params.gbn}'/>" />
		...
		<li>
			...
			<div class="cont">
				<input type="text" id="" name="regYmd" value="" class="ico_calendar datapicker_open" maxlength="10"/>
			</div>
		</li>
		<li>
		...
		<li>
			...
			<div class="cont">
				<input type="text" id="nam" name="nam" value="" maxlength="50"/>
			</div>
		</li>
		...
		<li>
			...
			<div class="cont">
				<input type="text" id="schTel" name="schTel" value="" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">세부주소</div>
			<div class="cont">
				<input type="text" id="schAddr" name="schAddr" value="" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">길이</div>
			<div class="cont">
				<input type="text" id="len" name="len" value="" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">교통사고[사망]</div>
			<div class="cont">
				<input type="text" id="die" name="die" value="" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">교통사고[부상]</div>
			<div class="cont">
				<input type="text" id="inj" name="inj" value="" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">도로폭</div>
			<div class="cont">
				<input type="text" id="rodWid" name="rodWid" value="" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">속도제한[㎞]</div>
			<div class="cont">
				<input type="text" id="spdLtd" name="spdLtd" value="" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">특이사항</div>
			<div class="cont">
				<input type="text" id="memo" name="memo" value="" maxlength="50"/>
			</div>
		</li>
		<li>
