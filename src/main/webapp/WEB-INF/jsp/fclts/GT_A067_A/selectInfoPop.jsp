...
<div class="tabCont active">
		...
		<li>
			<div class="tit">형상</div>
			<div class="cont">
				<c:out value='${result.frmCfnNam}'/>
			</div>
		</li>
		<li>
			<div class="tit">폭</div>
			<div class="cont">
				<c:out value='${result.wid}'/>
			</div>
		</li>
		<li>
...
<div class="tabCont">
		...
		<li>
			<div class="tit">폭</div>
			<div class="cont">
				<input type="text" id="wid" name="wid" value="" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">주소</div>
