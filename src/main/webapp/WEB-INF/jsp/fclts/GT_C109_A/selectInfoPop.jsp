...
<div class="tabCont">
		...
		<ul class="list_tp8 col_tp1">
			...
			<li>
				<div class="tit">면적</div>
				<div class="cont">
					<input type="text" class="w100p readonly" id="area" name="area" value="<c:out value='${result.area}'/>" maxlength="30" readOnly/>
				</div>
			</li>
			<li>
				<div class="tit">X</div>
...
$(function(){
	...
	var knd = new AjaxComboBox("#knd", {
		url				: "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=KND&refCd=C109_A'/>",
		baseItem	: {name: "--- 선택 ---", value: ""}
