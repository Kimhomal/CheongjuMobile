...
<div class="tabCont">
		...
		<li>
			<div class="tit"><span class="necessary">*</span>색상</div>
			<div class="cont">
...
$(function(){
	...
	var knd = new AjaxComboBox("#knd", {
		url				: "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=KND&refCd=A084_L'/>",
		baseItem	: {name: "--- 선택 ---", value: ""}
	}).load({select: "${result.knd}"});

	var clr = new AjaxComboBox("#clr", {
		url				: "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=CLR&refCd=A084_L'/>",
		baseItem	: {name: "--- 선택 ---", value: ""}
	}).load({select: "${result.clr}"});
