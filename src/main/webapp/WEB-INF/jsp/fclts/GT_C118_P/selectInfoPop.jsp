...
<div class="tabCont active">
		...
		<li>
			...
			<div class="cont">
				<c:out value='${result.stationId}'/>
			</div>
		</li>
		<li>
			<div class="tit">정류장명</div>
			<div class="cont">
...
<div class="tabCont">
		...
		<li>
			<div class="tit"><span class="necessary">*</span>정류장ID</div>
			<div class="cont">
				<input type="text" id="stationId" name="stationId" class="w80p readonly" value="" maxlength="30" />
				<a href="#this" data-lyrId="GT_C111_P" data-inputId="stationId" data-inputAttr ="STATION_ID" class="btn sml_tp2 bor_gray_tp3 facilitySelect" >선택</a>
			</div>
		</li>
		<li>
