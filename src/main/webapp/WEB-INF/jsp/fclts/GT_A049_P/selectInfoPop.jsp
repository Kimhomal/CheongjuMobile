...
<div class="tabCont active">
		...
		<li>
			<div class="tit">큐용도</div>
			<div class="cont">
				<c:out value='${result.qUseNam}'/>
			</div>
		</li>
		<li>
			<div class="tit">유형</div>
			<div class="cont">
				<c:out value='${result.drTypeNam}'/>
			</div>
		</li>
		<li>
...
<div class="tabCont">
		...
		<li>
			<div class="tit">매설위치</div>
			<div class="cont">
				<input type="text" id="layLoca" name="layLoca" value="<c:out value='${result.mkMdl}'/>" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">주소</div>
