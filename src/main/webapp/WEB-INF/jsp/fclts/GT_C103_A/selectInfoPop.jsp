...
<div class="tabCont active">
		...
		<ul class="list_tp8 col_tp1">
			...
			<li>
				<div class="tit">시점</div>
				<div class="cont">
					<c:out value='${result.spt}'/>
				</div>
			</li>
			<li>
				<div class="tit">종점</div>
				<div class="cont">
					<c:out value='${result.ept}'/>
				</div>
			</li>
			<li>
...
<div class="tabCont">
		...
		<ul class="list_tp8 col_tp1">
			...
			<li>
				<div class="tit">시점</div>
				<div class="cont">
					<input type="text" id="spt" name="spt" value="<c:out value='${result.spt}'/>" maxlength="50"/>
				</div>
			</li>
			<li>
				<div class="tit">종점</div>
				<div class="cont">
					<input type="text" id="ept" name="ept" value="<c:out value='${result.ept}'/>" maxlength="50"/>
				</div>
			</li>
			<li>
				<div class="tit">주소</div>
