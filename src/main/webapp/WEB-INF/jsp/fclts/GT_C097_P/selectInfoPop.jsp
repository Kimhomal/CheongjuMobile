...
<div class="tabCont active">
		...
		<ul class="list_tp8 col_tp1">
			...
			<li>
				...
				<div class="cont">
					<c:out value='${result.std}'/>
				</div>
			</li>
			<li>
				<div class="tit">종류</div>
				<div class="cont">
					<c:out value='${result.lhbKndNam}'/>
				</div>
			</li>
			<li>
...
<div class="tabCont">
		...
		<ul class="list_tp8 col_tp1">
			...
			<li>
				<div class="tit">규격</div>
				<div class="cont">
					<input type="text" id="std" name="std" value="<c:out value='${result.std}'/>" maxlength="50"/>
				</div>
			</li>
			<li>
				<div class="tit">종류</div>
				<div class="cont">
					<select id="lhbKnd" name="lhbKnd">
					</select>
				</div>
			</li>
			<li>
