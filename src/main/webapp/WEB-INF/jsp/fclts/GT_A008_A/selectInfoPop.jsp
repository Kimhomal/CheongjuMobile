...
<div class="tabCont active">
		...
		<li>
			...
			<div class="cont">
				<c:out value='${result.cssKndNam}'/>
			</div>
		</li>
		<li>
			<div class="tit">유형코드</div>
			<div class="cont">
				<c:out value='${result.typeCdeNam}'/>
			</div>
		</li>
		<li>
...
<div class="tabCont">
		...
		<li>
			<div class="tit"><span class="necessary">*</span>교차로명</div>
			<div class="cont">
				<input type="text" id="cssNam" name="cssNam" value="<c:out value='${result.cssNam}'/>" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">형태</div>
			<div class="cont">
				<select id="cssKnd" name="cssKnd">
				</select>
			</div>
		</li>
		<li>
			<div class="tit">유형코드</div>
			<div class="cont">
				<select id="typeCde" name="typeCde">
				</select>
			</div>
		</li>
		<li>
