...
<div class="tabCont active">
		...
		<li>
			<div class="tit">형태</div>
			<div class="cont">
				<c:out value='${result.mirrFrmNam}'/>
			</div>
		</li>
		<li>
			<div class="tit">종류</div>
			<div class="cont">
				<c:out value='${result.mirrKndNam}'/>
			</div>
		</li>
		<li>
			<div class="tit">지주타입</div>
			<div class="cont">
				<c:out value='${result.jijuTypeNam}'/>
			</div>
		</li>
		<li>
...
<div class="tabCont">
		...
		<li>
			<div class="tit">형태</div>
			<div class="cont">
				<select id="mirrFrm" name="mirrFrm">
				</select>
			</div>
		</li>
		<li>
			<div class="tit">종류</div>
			<div class="cont">
				<select id="mirrKnd" name="mirrKnd">
				</select>
			</div>
		</li>
		<li>
			<div class="tit">지주타입</div>
			<div class="cont">
				<select id="jijuType" name="jijuType">
				</select>
			</div>
		</li>
		<li>
