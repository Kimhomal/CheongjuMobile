...
<div class="tabCont active">
		...
		<li>
			...
			<div class="cont">
				<c:out value='${result.ctrMgrnu}'/>
			</div>
		</li>
		<li>
			<div class="tit">구분</div>
			<div class="cont">
				<c:out value='${result.sprtNam}'/>
			</div>
		</li>
		<li>
			<div class="tit">지름</div>
			<div class="cont">
				<c:out value='${result.sprtDmr}'/>
			</div>
		</li>
		<li>
			<div class="tit">높이</div>
			<div class="cont">
				<c:out value='${result.sprtHit}'/>
			</div>
		</li>
		<li>
			<div class="tit">단</div>
			<div class="cont">
				<c:out value='${result.sprtDanNam}'/>
			</div>
		</li>
		<li>
		...
		<li>
			<div class="tit">교체일</div>
			<div class="cont">
				<c:out value='${result.caeYmd}'/>
			</div>
		</li>
		<li>
...
<div class="tabCont">
		...
		<li>
			<div class="tit">지주ID</div>
			<div class="cont">
				<input type="text" id="ctrMgrnu" name="ctrMgrnu" class="w80p readonly" value="<c:out value='${result.ctrMgrnu}'/>" maxlength="30"/>
		...
		<li>
			<div class="tit">지름</div>
			<div class="cont">
				<input type="text" id="sprtDmr" name="sprtDmr" value="<c:out value='${result.sprtDmr}'/>" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">높이</div>
			<div class="cont">
				<input type="text" id="sprtHit" name="sprtHit" value="<c:out value='${result.sprtHit}'/>" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">단</div>
			<div class="cont">
				<select id="sprtDan" name="sprtDan">
				</select>
			</div>
		</li>
		<li>
		...
		<li>
			<div class="tit">교체일</div>
			<div class="cont">
				<input type="text" id="caeYmd" name="caeYmd" value="<c:out value='${result.caeYmd}'/>" class="ico_calendar datapicker_open" maxlength="10"/>
			</div>
		</li>
		<li>
			<div class="tit">주소</div>
...
$(function(){
	...
	var sprt = new AjaxComboBox("#sprt", {
		url				: "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=SPRT&refCd=A062_P'/>",
		baseItem	: {name: "--- 선택 ---", value: ""}
	}).load({select: "${result.sprt}"});

	var sprtDan = new AjaxComboBox("#sprtDan", {
		url				: "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=SPRT_DAN&refCd=A062_P'/>",
		baseItem	: {name: "--- 선택 ---", value: ""}
	}).load({select: "${result.sprtDan}"});

	var mop = new AjaxComboBox("#mop", {
		url				: "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=MOP&refCd=A062_P'/>",
		baseItem	: {name: "--- 선택 ---", value: ""}
