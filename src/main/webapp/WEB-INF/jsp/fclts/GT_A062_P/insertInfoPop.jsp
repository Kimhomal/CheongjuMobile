...
<!-- 지주 등록 : start-->
	...
	<input type="hidden" id="gbn" name="gbn" value="<c:out value='${params.gbn}'/>" />
		...
		<li>
			...
			<div class="cont">
				<input type="text" id="sprtDmr" name="sprtDmr" value="" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">높이</div>
			<div class="cont">
				<input type="text" id="sprtHit" name="sprtHit" value="" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">단</div>
		...
		<li>
			...
			<div class="cont">
				<input type="text" id="caeYmd" name="caeYmd" value="" class="ico_calendar datapicker_open" maxlength="10"/>
			</div>
		</li>
