...
<div class="tabCont active">
		...
		<li>
			...
			<div class="cont">
				<c:out value='${result.drnTypeNam}'/>
			</div>
		</li>
		<li>
			<div class="tit">방향</div>
			<div class="cont">
				<c:out value='${result.drn}'/>
			</div>
		</li>
		<li>
			<div class="tit">종류</div>
			<div class="cont">
				<c:out value='${result.signalCdeNam}'/>
			</div>
		</li>
		<li>
...
<div class="tabCont">
		...
		<li>
			<div class="tit">신호등명</div>
			<div class="cont">
				<input type="text" id="snlpNam" name="snlpNam" value="<c:out value='${result.snlpNam}'/>" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">설치일자</div>
		...
		<li>
			...
			<div class="cont">
				<input type="text" id="drn" name="drn" value="<c:out value='${result.drn}'/>" maxlength="50"/>
			</div>
		</li>
		<li>
...
$(function(){
	...
	var use = new AjaxComboBox("#use", {
		...
		baseItem	: {name: "--- 선택 ---", value: ""}
	}).load({select: "${result.use}"});

    mapMaker.mapAction.setImgFromAttr(facilityFt, {
        "signalCde" : "${result.signalCde}",
        "use" : "${result.use}",
    });
