...
<div class="tabCont active">
		...
		<li>
			<div class="tit">주차면수</div>
			<div class="cont">
				<c:out value='${result.cap}'/>
			</div>
		</li>
		<li>
			<div class="tit">장애인면수</div>
			<div class="cont">
				<c:out value='${result.disCap}'/>
			</div>
		</li>
		<li>
			<div class="tit">급지</div>
			<div class="cont">
				<c:out value='${result.geupjiNam}'/>
			</div>
		</li>
		<li>
		...
		<li>
			<div class="tit">유무료</div>
			<div class="cont">
				<c:out value='${result.paidFreeNam}'/>
			</div>
		</li>
		<li>
...
<div class="tabCont">
		...
		<li>
			<div class="tit">주차장명</div>
			<div class="cont">
				<input type="text" id="nam" name="nam" value="<c:out value='${result.nam}'/>" maxlength="30"/>
			</div>
		</li>
		<li>
			<div class="tit">주차면수</div>
			<div class="cont">
				<input type="text" id="cap" name="cap" value="<c:out value='${result.cap}'/>" maxlength="30"/>
			</div>
		</li>
		<li>
			<div class="tit">장애인면수</div>
			<div class="cont">
				<input type="text" id="disCap" name="disCap" value="<c:out value='${result.disCap}'/>" maxlength="30"/>
			</div>
		</li>
		<li>
		...
		<li>
			...
			<div class="cont">
				<input type="text" id="etc" name="etc" value="<c:out value='${result.etc}'/>" maxlength="30"/>
			</div>
		</li>
		<li>
			<div class="tit">주소</div>
