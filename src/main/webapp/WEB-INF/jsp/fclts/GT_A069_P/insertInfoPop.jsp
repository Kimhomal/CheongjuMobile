...
<!-- CCTV 등록 : start-->
	...
	<input type="hidden" id="gbn" name="gbn" value="<c:out value='${params.gbn}'/>" />
		...
		<li>
			...
			<div class="cont">
				<input type="text" id="esbHit" name="esbHit" value="" maxlength="50"/>
			</div>
		</li>
		<li>
		...
		<li>
			...
			<div class="cont">
				<input type="text" id="cnnSite" name="cnnSite" value="" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">통신방식[센터]</div>
			<div class="cont">
				<input type="text" id="cnnMain" name="cnnMain" value="" maxlength="50"/>
			</div>
		</li>
		<li>
		...
		<li>
			...
			<div class="cont">
				<input type="text" id="sgr" name="sgr" value="" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">관리청</div>
			<div class="cont">
				<input type="text" id="mgeChung" name="mgeChung" value="" maxlength="50"/>
			</div>
		</li>
