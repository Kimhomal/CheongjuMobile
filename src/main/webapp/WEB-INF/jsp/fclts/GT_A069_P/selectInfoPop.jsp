...
<div class="tabCont active">
		...
		<li>
			<div class="tit">지주ID</div>
			<div class="cont">
				<c:out value='${result.sprtMgrnu}'/>
			</div>
		</li>
		<li>
			<div class="tit">부착대ID</div>
			<div class="cont">
		...
		<li>
			...
			<div class="cont">
				<c:out value='${result.kndNam}'/>
			</div>
		</li>
		<li>
			<div class="tit">제조모델</div>
			<div class="cont">
		...
		<li>
			<div class="tit">설치높이</div>
			<div class="cont">
				<c:out value='${result.esbHit}'/>
			</div>
		</li>
		<li>
			<div class="tit">통신방식</div>
			<div class="cont">
				<c:out value='${result.cnnTypeNam}'/>
			</div>
		</li>
		<li>
			<div class="tit">통신방식[현장]</div>
			<div class="cont">
				<c:out value='${result.cnnSite}'/>
			</div>
		</li>
		<li>
			<div class="tit">통신방식[센터]</div>
			<div class="cont">
				<c:out value='${result.cnnMain}'/>
			</div>
		</li>
		<li>
		...
		<li>
			...
			<div class="cont">
				<c:out value='${result.sgr}'/>
			</div>
		</li>
		<li>
			<div class="tit">관리청</div>
			<div class="cont">
				<c:out value='${result.mgeChung}'/>
			</div>
		</li>
		<li>
...
<li>
		...
		<li>
			<div class="tit"><span class="necessary">*</span>부착대ID</div>
			<div class="cont">
		...
		<li>
			<div class="tit">설치높이</div>
			<div class="cont">
				<input type="text" id="esbHit" name="esbHit" value="<c:out value='${result.esbHit}'/>" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">통신방식</div>
			<div class="cont">
				<select id="cnnType" name="cnnType">
				</select>
			</div>
		</li>
		<li>
			<div class="tit">통신방식[현장]</div>
			<div class="cont">
				<input type="text" id="cnnSite" name="cnnSite" value="<c:out value='${result.cnnSite}'/>" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">통신방식[센터]</div>
			<div class="cont">
				<input type="text" id="cnnMain" name="cnnMain" value="<c:out value='${result.cnnMain}'/>" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">설치위치</div>
		...
		<li>
			<div class="tit">특이사항</div>
			<div class="cont">
				<input type="text" id="sgr" name="sgr" value="<c:out value='${result.sgr}'/>" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">관리청</div>
			<div class="cont">
				<input type="text" id="mgeChung" name="mgeChung" value="<c:out value='${result.mgeChung}'/>" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">주소</div>
...
$(function(){
	...
	var knd = new AjaxComboBox("#knd", {
		url				: "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=KND&refCd=A069_P'/>",
		baseItem	: {name: "--- 선택 ---", value: ""}
	}).load({select: "${result.knd}"});

	var cnnType = new AjaxComboBox("#cnnType", {
		url				: "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=CNN_TYPE&refCd=A069_P'/>",
		baseItem	: {name: "--- 선택 ---", value: ""}
	}).load({select: "${result.cnnType}"});
