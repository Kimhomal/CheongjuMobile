...
<div class="tabCont active">
		...
		<ul class="list_tp8 col_tp1">
			...
			<li>
				<div class="tit">연장</div>
				<div class="cont">
					<c:out value='${result.bycLen}'/>
				</div>
			</li>
			<li>
				<div class="tit">폭</div>
				<div class="cont">
					<c:out value='${result.bycWid}'/>
				</div>
			</li>
			<li>
				<div class="tit">시점위치</div>
				<div class="cont">
					<c:out value='${result.strDes}'/>
				</div>
			</li>
			<li>
				<div class="tit">종점위치</div>
				<div class="cont">
					<c:out value='${result.endDes}'/>
				</div>
			</li>
			<li>
...
<div class="tabCont">
		...
		<ul class="list_tp8 col_tp1">
			...
			<li>
				<div class="tit">연장</div>
				<div class="cont">
					<input type="text" id="bycLen" name="bycLen" value="<c:out value='${result.bycLen}'/>" maxlength="50"/>
				</div>
			</li>
			<li>
				<div class="tit">폭</div>
				<div class="cont">
					<input type="text" id="bycWid" name="bycWid" value="<c:out value='${result.bycWid}'/>" maxlength="50"/>
				</div>
			</li>
			<li>
				<div class="tit">시점위치</div>
				<div class="cont">
					<input type="text" id="strDes" name="strDes" value="<c:out value='${result.strDes}'/>" maxlength="50"/>
				</div>
			</li>
			<li>
				<div class="tit">종점위치</div>
				<div class="cont">
					<input type="text" id="endDes" name="endDes" value="<c:out value='${result.endDes}'/>" maxlength="50"/>
				</div>
			</li>
			<li>
				<div class="tit">주소</div>
...
<!-- 			<div class="tit">비고</div> -->
<!-- 			<div class="cont"> -->
<!-- 				<input type="text" id="etcDes" name="etcDes" value="" maxlength="50"/> -->
<!-- 			</div> -->
<!-- 		</li> -->
