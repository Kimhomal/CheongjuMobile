...
<!-- 자전거전용도로 등록 : start-->
	...
	<input type="hidden" id="gbn" name="gbn" value="<c:out value='${params.gbn}'/>" />
		...
		<li>
			...
			<div class="cont">
				<input type="text" id="bycLen" name="bycLen" value="" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">폭</div>
			<div class="cont">
				<input type="text" id="bycWid" name="bycWid" value="" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">시점위치</div>
			<div class="cont">
				<input type="text" id="strDes" name="strDes" value="" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">종점위치</div>
			<div class="cont">
				<input type="text" id="endDes" name="endDes" value="" maxlength="50"/>
			</div>
		</li>
<!-- 		<li> -->
