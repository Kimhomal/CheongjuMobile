...
<div class="tabCont active">
		...
		<li>
			...
			<div class="cont">
				<c:out value='${result.statNam}'/>
			</div>
		</li>
		<li>
			<div class="tit">길이</div>
			<div class="cont">
				<c:out value='${result.asnLenNam}'/>
			</div>
		</li>
		<li>
...
<div class="tabCont">
		...
		<input type="hidden" id="hisid" name="hisid" value="<c:out value='${params.hisid}'/>" />
		<input type="hidden" id="geom" name="geom" />
