...
<!-- 배선도 등록 : start-->
	...
	<input type="hidden" id="gbn" name="gbn" value="<c:out value='${params.gbn}'/>" />
		...
		<li>
			...
			<div class="cont">
				<input type="text" id="depthSt" name="depthSt" value="" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">중간점심도</div>
			<div class="cont">
				<input type="text" id="depthMi" name="depthMi" value="" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">끝점심도</div>
			<div class="cont">
				<input type="text" id="depthEd" name="depthEd" value="" maxlength="50"/>
			</div>
		</li>
		<li>
