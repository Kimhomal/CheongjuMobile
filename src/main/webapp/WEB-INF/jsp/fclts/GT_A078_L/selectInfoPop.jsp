...
<div class="tabCont active">
		...
		<li>
			<div class="tit">방식</div>
			<div class="cont">
				<c:out value='${result.lineMetNam}'/>
			</div>
		</li>
		<li>
			<div class="tit">시작점심도</div>
			<div class="cont">
				<c:out value='${result.depthSt}'/>
			</div>
		</li>
		<li>
			<div class="tit">중간점심도</div>
			<div class="cont">
				<c:out value='${result.depthMi}'/>
			</div>
		</li>
		<li>
			<div class="tit">끝점심도</div>
			<div class="cont">
				<c:out value='${result.depthEd}'/>
			</div>
		</li>
		<li>
...
<div class="tabCont">
		...
		<li>
			<div class="tit">시작점심도</div>
			<div class="cont">
				<input type="text" id="depthSt" name="depthSt" value="<c:out value='${result.depthSt}'/>" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">중간점심도</div>
			<div class="cont">
				<input type="text" id="depthMi" name="depthMi" value="<c:out value='${result.depthMi}'/>" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">끝점심도</div>
			<div class="cont">
				<input type="text" id="depthEd" name="depthEd" value="<c:out value='${result.depthEd}'/>" maxlength="50"/>
			</div>
		</li>
		<li>
			<div class="tit">메모</div>
		...
		<li>
			<div class="tit">길이</div>
			<div class="cont">
				<input type="text" class="w100p readonly" value="<c:out value='${result.len}'/>" maxlength="30" readOnly/>
			</div>
		</li>
		<li>
			<div class="tit">X</div>
...
$(function(){
	...
	var knd = new AjaxComboBox("#knd", {
		url				: "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=KND&refCd=A078_L'/>",
		baseItem	: {name: "--- 선택 ---", value: ""}
	}).load({select: "${result.knd}"});

	var lineMet = new AjaxComboBox("#lineMet", {
		url				: "<c:url value='/common/util/code/combobox.json?codegroup=commonCode&codeId=LINE_MET&refCd=A078_L'/>",
		baseItem	: {name: "--- 선택 ---", value: ""}
...
function updateInfo() {
	...
	var length = ft.getGeometry().getLength();
	var pt = ol.extent.getCenter(ft.getGeometry().getExtent());
