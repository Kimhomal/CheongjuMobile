...
<!-- 횡단보도 등록 : start-->
	...
	<input type="hidden" id="gbn" name="gbn" value="<c:out value='${params.gbn}'/>" />
		...
		<li>
			...
			<div class="cont">
				<input type="text" id="hol" name="hol" value="" maxlength="50"/>
			</div>
		</li>
<!-- 		<li> -->
<!-- 			<div class="tit">세로길이</div> -->
<!-- 			<div class="cont"> -->
<!-- 				<input type="text" id="vel" name="vel" value="" maxlength="50"/> -->
<!-- 			</div> -->
<!-- 		</li> -->
		<li>
...
// 	var ft = mapMaker.layer.polygon.getSource().getFeatures()[0];
   ...
   var bufferFt =  mapMaker.mapAction.setFeatureToBuffer(feature, $("#hol").val() / 2 ,"CAP_FLAT");

	var geom = mapMaker.getWkt(bufferFt);
	$("#geom").val(geom);
